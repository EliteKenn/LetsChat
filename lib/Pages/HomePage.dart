...
class HomeScreenState extends State<HomeScreen> {
  ...
  controlSearching(String userName){
    ...
    Future<QuerySnapshot> allFoundUsers = Firestore.instance.collection('users').where('nickname').
          ...
          children: <Widget>[
            GestureDetector(
              ...
              child: ListTile(
                ...
                subtitle: Text(
                  "Joined: " + DateFormat("dd MMMM, yyyyy - hh:mm:aa").format(DateTime.fromMillisecondsSinceEpoch(int.parse(eachUser.createdAt))),
