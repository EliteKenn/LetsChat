...
//Have a scaffold, which holds a container, then we use a gradient for the login screen
    return Scaffold(
      body: Container(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,//vertical(column)
          crossAxisAlignment: CrossAxisAlignment.center,//horizontal(row)
          children: <Widget>[
            Text(
              'Telegram Clone',
  ...
  Future<Null>controlSignIn() async{
    ...
    if(firebaseUser != null){
      ...
      //Save data to Firestore if we encountered a new user
      if(documentSnapshots.length == 0){
        Firestore.instance.collection("users").document(firebaseUser.uid).setData({
          "nickname": firebaseUser.displayName,
          "photoUrl":firebaseUser.photoUrl,
          "id":firebaseUser.uid,
          "aboutMe":"I am using Kenn's Telegram Clone App",
      ...
      Fluttertoast.showToast(msg: "Congratz! Sign in Successful");
      this.setState((){
        isLoading = false;
      });
